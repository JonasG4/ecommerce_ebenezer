  ...
  return (
    <div className="flex items-center justify-between mb-4 gap-4">
      ...
      <div className="flex items-center gap-2">
        <Link
          className="py-2 px-3 ring-1 shadow-md ring-indigo-600 rounded-md flex bg-indigo-600 text-gray-50 text-sm hover:bg-indigo-700 hover:text-gray-50 duration-200"
          href={`/nx-admin/${table}/create`}
        >
          <CiruclePlusIcon
            className={"w-4 md:mr-2 fill-gray-50 text-indigo-600"}
          />
        ...
        <button
          type="button"
          className="bg-white shadow-md py-[10px] w-12 rounded-md ring-1 ring-gray-400 flex items-center justify-center hover:ring-indigo-400 group/peer"
          onClick={getData}
        >
        ...
        <button
          className="py-2 px-3 ring-1 shadow-md ring-gray-400 rounded-md hover:ring-indigo-500 bg-white text-sm duration-200 flex items-center gap-2 group/exportar"
